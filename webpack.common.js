...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({ // to generate search-list.html file from a template with scripts and styles tags.
      template: './src/search-list.html',
